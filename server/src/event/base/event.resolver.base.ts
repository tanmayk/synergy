...
export class EventResolverBase {
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => [EventLog], { name: "eventLog" })
  @nestAccessControl.UseRoles({
    resource: "EventLog",
    action: "read",
    possession: "any",
  })
  async resolveFieldEventLog(
    @graphql.Parent() parent: Event,
    @graphql.Args() args: EventLogFindManyArgs
  ): Promise<EventLog[]> {
    const results = await this.service.findEventLog(parent.id, args);
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => [User], { name: "volunteers" })
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "read",
    possession: "any",
  })
  async resolveFieldVolunteers(
    @graphql.Parent() parent: Event,
    @graphql.Args() args: UserFindManyArgs
  ): Promise<User[]> {
    const results = await this.service.findVolunteers(parent.id, args);
